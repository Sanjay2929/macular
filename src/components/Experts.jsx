...
import brianImg from "../assets/img/webp/brianImg.webp";
import GeorgeImg from "../assets/img/webp/georgeImg.webp";
const Experts = () => {
  return (
    <div>
      <section className="expertBgImg mx_35 py-2 mb-5">
        <Container>
            <h2 className="text-center ff_jakarta fw_500 fs_4x8l clr_white opacity_90 lh_120 py-5">
              ...
              <Col lg={5} sm={6} xs={11}>
                <div className="ps-lg-5 pe-1">
                  ...
                  <div className="d-flex justify-content-between align-items-center pt-3 pb-2">
                    <h3 className='fw_600 ff_jakarta fs_2x4l clr_FA mb-0'>Brian A. Bakke, PhD</h3>
                    <a href="#">
                      <svg
                        width="32"
                        height="33"
                  ...
                  <h5 className='fw_400 ff_roboto fs_md clr_FA lh_150'>PhD Biochemistry</h5>
                </div>
              </Col>
              <Col lg={5} sm={6} xs={11} >
                <div className="pe-lg-5 ps1">
                  ...
                  <div className="d-flex justify-content-between align-items-center pt-3 pb-2">
                    <h3 className='fw_600 ff_jakarta fs_2x4l clr_FA mb-0'>George W. Rozakis Md</h3>
                    <a href="#">
                      <svg
                        width="32"
                        height="33"
                  ...
                  <h5 className='fw_400 ff_roboto fs_md clr_FA lh_150'>Biomedical Engineer</h5>
                </div>
              </Col>
            </Row>
        </Container>
