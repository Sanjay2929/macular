...
import patient from "../assets/img/webp/patientsRecovered.webp";
  ...
  return (
    <>
      <section className="py-sm-5 pt-4 my-md-5 position-relative">
        <Container className="py-sm-5 pt-5 pb-3 position-relative z_2">
          <Row className="justify-content-lg-between justify-content-center align-items-center pb-5">
            <Col lg={5} sm={9} xs={10} className="ps-0" data-aos="fade-right">
              <div className="pe-lg-5 ps-4 patientImgBg position-relative">
                ...
                <div className="d-flex align-items-center position-absolute macular gap_sm_21 gap_10 recoverAnimation1">
                  ...
                  <h4 className="mb-0 ff_poppins fw_400 fs_md clr_FA">
            ...
            >
              ...
              <p className="fw_400 ff_poppins fs_md clr_FA opacity_70 lh_150 pt-1 pb-sm-4 mb-3">
        ...
        <span className="recoverGreenShadow position-absolute start-0 top-50 transformY-50 z_0"></span>
      </section>
    </>
  );
};
